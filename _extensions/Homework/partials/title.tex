...
$if(title)$
\title{$title$\thanks{CONTACT: $for(by-author)$$if(by-author.email)$$by-author.name.literal$. Email: \href{mailto:$by-author.email$}{\nolinkurl{$by-author.email$}}. $endif$$endfor$}}
$endif$
$if(subtitle)$
\usepackage{etoolbox}
\makeatletter
